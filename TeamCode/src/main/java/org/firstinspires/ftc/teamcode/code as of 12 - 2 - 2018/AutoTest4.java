...
public class AutoTest4 extends LinearOpMode {
    ...
    //Detector object
    private GoldAlignDetector detector2;
    ...
    private void autoDrive(double desiredX, double desiredY, double speed, String lookat) {
