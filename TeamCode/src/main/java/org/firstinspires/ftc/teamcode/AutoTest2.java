...
public class AutoTest2 extends OpMode {
    ...
    public void leftShift(double speed, long time) {
    ...
    public void rightShift(double speed, long time) {
    ...
    public void turnCountClock(double speed, long time) {
    ...
    public void moveArm(double speed, long time) {

        goat.arm_motor.setPower(speed);
        sleep(time);
    }

    public void detachToPoint(double speed, double time, double angle) {
