...
public class Hermione extends LinearOpMode {
    ...
    public void drive(){
        ...
        double modifiedTheta = -1 * theta + Math.PI/4;
        ...
        goat.front_left.setPower(-1 * (Px - Protate));
        goat.back_left.setPower(Px - Protate);
        goat.back_right.setPower(Py + Protate);
        goat.front_right.setPower(-1 * (Py - Protate));

    }

    public void intake() {

        goat.Intake.setPower(gamepad2.right_trigger + (gamepad2.left_trigger * -1));
    ...
    public void arm() {
        ...
        goat.arm_motor_1.setPower(gamepad2.left_stick_y);
        goat.arm_motor_2.setPower(-1 * (gamepad2.left_stick_y));
    ...
    public void deadBois() {
        ...
        if (gamepad2.y) {
            ...
            goat.deadBois.setPosition(1);

        } else if (gamepad2.a) {

            goat.deadBois.setPosition(0.5);
