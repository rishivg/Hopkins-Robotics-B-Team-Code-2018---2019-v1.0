...
public class Hermione extends LinearOpMode {
    ...
    public void drive(){
        ...
        if(gamepad1.left_stick_button){ //Removes gyroAngle from the equation meaning the robot drives normally
            gyroAngle = 0;
        }
    ...
    public void arm() { /*
        ...
        if (potentiometer.getVoltage() < 3.3)
        {
            ...
            telemetry.addData("Something went wrong plz help");
